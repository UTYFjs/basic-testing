...
describe('BankAccount', () => {
  ...
  test('should deposit money', () => {
    ...
    expect(account.getBalance()).toEqual(initialBalance + moneyForDeposit);
  });
  ...
  test('should transfer money', () => {
    ...
    expect(account2.getBalance()).toEqual(initialBalance + transferMoney);
  });
